...
public class FormatAction extends StyledEditorKit.StyledTextAction
{
	...
	private static final long	serialVersionUID	= 7672063208238845511L;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			SimpleInfoDialog.show(parentEkit.getParentWindow(), "", true, Translatrix.getTranslationString("ErrorNoTextSelected"), SimpleInfoDialog.ERROR);
		}
		else
		{
