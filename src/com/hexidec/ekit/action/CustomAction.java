...
public class CustomAction extends StyledEditorKit.StyledTextAction
{
	...
	private static final long	serialVersionUID	= -5836821404118948772L;
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(this.isEnabled())
		{
			...
			{
				SimpleInfoDialog.show(parentEkit.getParentWindow(), Translatrix.getTranslationString("Error"), true, Translatrix.getTranslationString("ErrorNoTextSelected"), SimpleInfoDialog.ERROR);
			}
			else
			{
				...
				if(htmlTag.toString().equals(HTML.Tag.A.toString()))
				{
					...
					{
						UserInputAnchorDialog uidInput = UserInputAnchorDialog.open(parentEkit.getParentWindow(), Translatrix.getTranslationString("AnchorDialogTitle"), true, currentAnchor);
				...
				else if(htmlTag.toString().equals(HTML.Tag.FONT.toString()))
				{
					...
					{
						Color color = JColorChooser.showDialog(parentEkit.getParentWindow(), Translatrix.getTranslationString("CustomColorDialog"), Color.black);
					    if(color != null)
						{
