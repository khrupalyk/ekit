...
public class SetFontFamilyAction extends StyledEditorKit.FontFamilyAction
{
	...
	private static final long	serialVersionUID	= 4032463798708082429L;

	/** @deprecated inner class variable should not be accessible directly */
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			FontSelectorDialog fsdInput = FontSelectorDialog.show(parentEkit.getParentWindow(), Translatrix.getTranslationString("FontDialogTitle"), true, "face", parentEkit.getTextPane().getSelectedText());
