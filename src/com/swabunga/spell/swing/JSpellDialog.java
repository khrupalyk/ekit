...
public class JSpellDialog extends JDialog implements ActionListener, WindowListener {
  ...
  public static JSpellDialog create(Window owner, String title, boolean modal) {
	if (owner instanceof Frame) {
	  return new JSpellDialog((Frame) owner, title, modal);
	} else if (owner instanceof Dialog) {
	  return new JSpellDialog((Dialog) owner, title, modal);
	} else {
