...
compilecore:
  echo [] compiling core...
  javac -source 1.2 -target 1.2 -deprecation com/hexidec/ekit/EkitCore.java
...
compilespellcore:
  ...
  javac -source 1.2 -target 1.2 -deprecation com/hexidec/ekit/EkitCoreSpell.java
  if $status == 0 goto compileapp
  goto failure
compileapp:
  echo [] compiling applet...
  javac -source 1.2 -target 1.2 -deprecation com/hexidec/ekit/EkitApplet.java
  if $status == 0 goto makejar
  goto failure
makejar:
  echo [] jarring...
  jar cf $jarname  com/hexidec/ekit/*.class com/hexidec/ekit/action/*.class com/hexidec/ekit/component/*.class com/hexidec/util/Base64Codec.class com/hexidec/util/Translatrix.class com/hexidec/ekit/icons/*.png com/hexidec/ekit/*.properties com/hexidec/ekit/thirdparty/print/*.class $additionalfiles
